      ...
      <View className="flex-1 px-6 pt-16 pb-8 items-center justify-between">
        <View className="items-center gap-6 mt-12">
          <View className="w-24 h-24 rounded-full bg-green-100 items-center justify-center">
            <Ionicons name="leaf" size={56} color={Palette.green[600]} />
          </View>
          <View className="items-center gap-2">
            <Text className="text-3xl text-body font-bold">これどう捨てる？</Text>
            <Text className="text-base text-muted text-center">
              飯田市のごみ分別を、写真一枚で。
            </Text>
          </View>
          <View className="rounded-full bg-green-100 px-4 py-1">
            <Text className="text-green-600 text-sm">ベータ版</Text>
          </View>
        </View>
